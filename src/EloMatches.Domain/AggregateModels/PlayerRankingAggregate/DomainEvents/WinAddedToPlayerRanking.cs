...
{
    public class WinAddedToPlayerRanking : DomainEvent
    {
        public WinAddedToPlayerRanking(PlayerId playerId, EloRatingStatistics eloRatingStatistics, NumberOfMatchesStatistics numberOfMatchesStatistics, ScoreStatistics scoreStatistics, MatchStreak matchStreak, DateTime? lastMatchDate) : base(playerId, "PlayerRanking")
        {
            PlayerId = playerId;
