...
{
    public class PlayerRankingCreated : DomainEvent
    {
        public PlayerRankingCreated(PlayerId playerId, EloRatingStatistics eloRatingStatistics, NumberOfMatchesStatistics numberOfMatchesStatistics, ScoreStatistics scoreStatistics, MatchStreak matchStreak, DateTime? lastMatchDate) : base(playerId, "PlayerRanking")
        {
            PlayerId = playerId;
